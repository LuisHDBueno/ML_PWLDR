...
function test_build_ldr()
    ...
    dist_constructor = (a, b)-> truncated(Uniform(demand_min, demand_max), a, b)
    pwldr = PiecewiseLDR.PWLDR(ldr, optimizer, dist_constructor, n_segments_vec)
...
function test_build_pwldr()
    ...
    dist_constructor = (a, b)-> truncated(Uniform(demand_min, demand_max), a, b)
    pwldr = PiecewiseLDR.PWLDR(ldr, optimizer, dist_constructor)
